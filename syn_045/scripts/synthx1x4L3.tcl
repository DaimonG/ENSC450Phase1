...
set target_library "stdX1X4L3.db"
...
report_reference  >  ./results/X1X4L3Lib.rpt
report_timing    -transition_time -capacitance >> ./results/X1X4L3Lib.rpt
report_power     >> ./results/X1X4L3Lib.rpt
...
write -format verilog -hier -o   ./results/X1X4L3Lib.ref.v
